...
impl TMF645ServiceQualificationManagement {
    pub fn new(persist: Option<Persistence>) -> TMF645ServiceQualificationManagement {
        TMF645ServiceQualificationManagement { persist }
    }
    ...
    pub async fn add_check_qualification(
        &self,
        item: CheckServiceQualification,
    ) -> Result<Vec<CheckServiceQualification>, PlatypusError> {
        let result = self
            .persist
            .as_ref()
            .unwrap()
    ...
    pub async fn get_check_qualifications(
        &self,
    ...
    pub async fn get_check_qualification(
        &self,
        id: String,
        query_ops: QueryOptions,
    ) -> Result<Vec<CheckServiceQualification>, PlatypusError> {
    ...
    pub async fn update_check_qualification(
        &self,
        id: String,
        patch: CheckServiceQualification,
    ) -> Result<Vec<CheckServiceQualification>, PlatypusError> {
        let result = self
            .persist
            .as_ref()
    ...
    pub async fn delete_check_qualification(
        &self,
        id: String,
    ) -> Result<CheckServiceQualification, PlatypusError> {
